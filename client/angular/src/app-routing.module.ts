...
import { OrderItemDetailComponent } from './app/order-item/order-item-detail/order-item-detail.component';
...
const Routes: Routes = [
  ...
  { path: 'orders/:id/orderitems/:itemid', component: OrderItemDetailComponent }
];
