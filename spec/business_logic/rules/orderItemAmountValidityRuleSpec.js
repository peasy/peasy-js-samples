describe("OrderItemAmountValidityRule", function() {
  ...
  it("invalidates when order item's amount does not equal product price * order items's quanity", () => {
  ...
  it("validates when order item's amount equals product price * order items's quanity", () => {
